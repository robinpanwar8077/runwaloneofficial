...
export default function EnquireButton() {
  ...
  return (
    <>
      ...
      <button
        onClick={handleClick}
        className="hidden md:block fixed bottom-[5px] right-[15px] w-fit px-5 py-2.5 bg-[#aa8a4b] text-white text-lg text-center border-none z-[4] cursor-pointer hover:opacity-90 transition-opacity"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 flex z-[4]">
        <a
